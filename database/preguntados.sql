...
INSERT INTO preguntas (descripcion, estado, entregadas, hit, id_categoria) VA
    ('¿Cuál es la capital de Francia?', 'activa', 100, 50,
    ('¿Quién escribió "Don Quijote"?', 'activa', 100, 50,
    ('¿Cuál es el equipo que más veces ganó la UEFA Champions League?', 'activa', 100, 50,
    ('¿En qué año llegó el hombre a la luna?', 'activa', 100, 50,
    ('¿Cuál es el elemento químico con símbolo "O"?','activa', 100, 50,
    ('¿Cuál es el río más largo del mundo?','activa', 100, 50,
    ('¿Qué ciudad es conocida como la Gran Manzana?','activa', 100, 50,
    ('¿Quién pintó la Mona Lisa?','activa', 100, 50,
    ('¿Quién escribió "Cien años de soledad"?', 'activa', 100, 50,
    ('¿Cuál es el deporte más popular del mundo?', 'activa', 100, 50,
    ('¿En qué año se fundó la FIFA?', 'activa', 100, 50,
    ('¿Cuál es la fórmula química del agua?', 'activa', 100, 50,
    ('¿Quién descubrió la penicilina?', 'activa', 100, 50,
    ('¿Cuál es la capital de Japón?', 'activa', 100, 50,
    ('¿Quién escribió "Hamlet"?', 'activa', 100, 50,
    ('¿Cuál es el planeta más cercano al sol?', 'activa', 100, 50,
    ('¿Quién es conocido como el padre de la física moderna?', 'activa', 100, 50,
    ('¿Cuál es el océano más grande del mundo?', 'activa', 100, 50,
    ('¿Qué país es el mayor productor de café?', 'activa', 100, 50,
    ('¿Quién escribió "La Divina Comedia"?', 'activa', 100, 50,
    ('¿Quién ganó el primer Mundial de Fútbol?', 'activa', 100, 50,
